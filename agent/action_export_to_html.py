...
def generate_html(box_data, resolved_pairs, best_lang, student_id_map):
    ...
    <body>
    <div id="main">
        <div style="width: 100%; text-align: center; padding: 0 0 10px 0; font-family: sans-serif; font-size: 15px; display: flex; align-items: center; justify-content: center; gap: 4px; font-weight: bold;">
            Generated by
            <svg width="18" height="18" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg" style="vertical-align: middle;">
            ...
            <a href="https://github.com/oneton429/BABox" target="_blank" style="color: #0075FF; text-decoration: none; font-weight: bold; font-size: 15px;">Oneton429/BABox</a>
        </div>
        {body_content}
    </div>
